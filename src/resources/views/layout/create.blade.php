@extends('boilerplate::layout.index', [
    ...
    'subtitle' => __('boilerplate-email-editor::layout.add.title'),
    'breadcrumb' => [
        __('boilerplate-email-editor::editor.title'),
        __('boilerplate-email-editor::layout.title') => 'emaileditor.layout.index',
        __('boilerplate-email-editor::layout.add.title')
    ]
])

@section('content')
    {!! Form::open(['route' => 'emaileditor.layout.store', 'method' => 'post', 'autocomplete'=> 'off', 'id' => 'layout-form']) !!}
    <div class="row">
    ...
    <div class="box box-info">
        <div class="box-header">
            <h3 class="box-title">{{ __('boilerplate-email-editor::layout.add.title') }}</h3>
        </div>
        <div class="box-body">
            ...
            <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                ...
                {{ Form::textarea('content', old('content', $defaultContent), ['class' => 'form-control', 'id' => 'body']) }}
